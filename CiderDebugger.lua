...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/amybrowne/Library/Application Support/luaglider2/dev";local SOCKET_PORT=55813;local GLIDER_MAIN_FOLDER= "/Users/amybrowne/NetBeansProjects/InTheDarkness";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
